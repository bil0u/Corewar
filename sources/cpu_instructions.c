...
/*   Updated: 2018/03/31 00:04:36 by upopee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ldi_instr(t_vcpu *cpu)
{
	...
	if ((reg_dst = arg[2]) != 0 && --reg_dst < REG_NUMBER)
	{
		...
		cpu->carry = (cpu->registers[reg_dst] == 0);
